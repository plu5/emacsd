...
(let ((c fsffdark-display-class))
  (custom-theme-set-faces
   ...
   `(outline-7 ((,c (:slant italic :foreground "#4800bf"))))
   `(outline-8 ((,c (:slant italic :foreground "#001bdf"))))
   ...
   `(imenu-list-entry-face-1 ((,c (:foreground "#7e6e02"))))
   `(imenu-list-entry-face-2 ((,c (:foreground "#983f01"))))
   `(imenu-list-entry-face-3 ((,c (:foreground "#90010f"))))
